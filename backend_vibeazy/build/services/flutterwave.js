...
var flwRequest_1 = __importDefault(require("../config/flwRequest"));
var generatePaymentLink = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 5]);
                return [4 /*yield*/, flwRequest_1.default.post("/payments", body)];
            case 2:
                response = _a.sent();
                if (response.data) {
                    console.log("=======================================================");
            ...
            case 3:
                err_1 = _a.sent();
                errorString = (0, user_utils_1.stringifyError)(err_1);
    ...
    return __awaiter(this, arguments, void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _c.trys.push([1, 3, , 5]);
                    return [4 /*yield*/, flwRequest_1.default.get(flwVerifyEndpoint)];
                case 2:
                    data = (_c.sent()).data;
                ...
                case 3:
                    err_2 = _c.sent();
                    errorString = (0, user_utils_1.stringifyError)(err_2);
                    return [4 /*yield*/, pris_client_1.default.errorLogs.create({
                            data: {
...
var createVirtualAccount = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                _c.trys.push([1, 3, , 5]);
                return [4 /*yield*/, flwRequest_1.default.post(flwVirtualEndpoint, body)];
            case 2:
                response = _c.sent();
                console.log(response.data);
                return [2 /*return*/, response.data];
            case 3:
                err_3 = _c.sent();
                log = (0, user_utils_1.stringifyError)(err_3);
...
exports.initiateBankTransfer = (function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 1:
                _d.trys.push([1, 3, , 5]);
                return [4 /*yield*/, flwRequest_1.default.post(flwTransferEndpoint, body)];
            case 2:
                response = _d.sent();
                return [2 /*return*/, response.data];
            case 3:
                err_4 = _d.sent();
                log = (0, user_utils_1.stringifyError)(err_4);
                errs = err_4;
...
var getBankCodes = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, flwRequest_1.default.get(reqUrl)];
            case 2:
                response = _a.sent();
                return [2 /*return*/, response.data];
            case 3:
...
var getAccountNumberDetail = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                _c.trys.push([1, 3, , 4]);
                return [4 /*yield*/, flwRequest_1.default.post(reqUrl, reqBody)];
            case 2:
                response = _c.sent();
                return [2 /*return*/, response.data];
            case 3:
...
var verifyTransferReference = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    ...
    return __generator(this, function (_e) {
        switch (_e.label) {
            ...
            case 1:
                _e.trys.push([1, 3, , 4]);
                return [4 /*yield*/, flwRequest_1.default.get(requestUrl)];
            case 2:
                response = _e.sent();
                console.log(response.data);
