...
var channelWebHookData_1 = require("./channelWebHookData");
...
var channelWebHookData_2 = require("./channelWebHookData");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, flutterwave_1.verifyTransferReference)({ transferId: dataFromWebhook.data.id })];
            case 1:
                isValid = _a.sent();
                if (!isValid) {
                ...
                return [3 /*break*/, 4];
            case 2: return [4 /*yield*/, (0, flutterwave_1.flwTransactionVerification)({ txRef: dataFromWebhook.data.tx_ref })];
            case 3:
            ...
            case 5:
                ...
                return [4 /*yield*/, (0, channelWebHookData_1.channelWebHookData)(dataFromWebhook)];
            case 6:
                _a.sent();
                return [3 /*break*/, 11];
            case 7:
                if (!(dataFromWebhook["event.type"] === "Transfer")) return [3 /*break*/, 9];
                return [4 /*yield*/, (0, channelWebHookData_1.updateWithDrawalTransaction)(dataFromWebhook)];
            case 8:
                _a.sent();
                return [3 /*break*/, 11];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, channelWebHookData_2.updateCashwyreWithDrawalTransaction)(dataFromWebhook)];
            case 2:
                _a.sent();
            ...
            case 6:
                ...
                console.log("An error occurred processing webhook");
                console.log(e_2);
                error = (0, user_utils_1.stringifyError)(e_2);
                return [4 /*yield*/, pris_client_1.default.errorLogs.create({
                        data: {
                            txRef: dataFromWebhook["eventData"].reference,
                            logs: (0, user_utils_1.stringifyError)(error)
