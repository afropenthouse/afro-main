        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (!accessToken) {
                        return [2 /*return*/, response_handler_1.default.sendErrorResponse({ res: res, error: "Invalid token supplied", status_code: "LOGIN_REDIRECT" })];
                    }
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 3, , 4]);
                ...
                case 2:
                    session = _b.sent();
                    if (!session) {
                        return [2 /*return*/, response_handler_1.default.sendErrorResponse({ res: res, error: "session does not exist" })];
                    }
                    user = session.user;
                    req.user = {
                        userId: user.id,
