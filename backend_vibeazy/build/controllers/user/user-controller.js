...
exports.getUserProfileDetail = exports.createPin = exports.getWalletInfo = void 0;
...
exports.createPin = (0, wrapper_1.catchAuthError)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                pin = req.body.pin;
                return [4 /*yield*/, pris_client_1.default.user.findFirst({ where: { id: (_a = req.user) === null || _a === void 0 ? void 0 : _a.userId } })];
            case 1:
                user = _b.sent();
                if (!user || user.hasCreatedPin) {
                    return [2 /*return*/, response_handler_1.default.sendErrorResponse({ res: res, error: "Pin has already been created", code: 400 })];
                }
                return [4 /*yield*/, (0, user_utils_1.bcryptHash)(pin)];
            case 2:
                hashedPin = _b.sent();
            ...
            case 3:
                _b.sent();
                return [2 /*return*/, response_handler_1.default.sendSuccessResponse({ res: res, message: "Pin created successfully" })];
        }
    });
}); });
exports.getUserProfileDetail = (0, wrapper_1.catchAuthError)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, pris_client_1.default.user.findFirst({ where: { id: (_a = req.user) === null || _a === void 0 ? void 0 : _a.userId } })];
            case 1:
                user = _b.sent();
                if (!user) {
                    return [2 /*return*/, response_handler_1.default.sendErrorResponse({ res: res, error: "User does not exist", code: 400 })];
                }
