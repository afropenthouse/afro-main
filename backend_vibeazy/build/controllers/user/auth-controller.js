...
exports.resetPassword = exports.forgotPassword = exports.logOutUser = exports.refreshUserToken = exports.signInUser = exports.verifyLoginCredentials = exports.verifyUserEmail = exports.userSignUp = void 0;
...
exports.userSignUp = (0, wrapper_1.catchDefaultError)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, username, password, phoneNumber, referralUsername, userEmail, existingUser, isUserNameExisting, referralId, referralUser, walletUpdate, transaction, notification, hashedPassword, newUserId, newUser, otpCode, otpObject;
    var _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                _a = req.body, email = _a.email, username = _a.username, password = _a.password, phoneNumber = _a.phoneNumber, referralUsername = _a.referralUsername;
            ...
            case 2:
                isUserNameExisting = _d.sent();
                //only validate username for a new user
                if (!existingUser && isUserNameExisting) {
                    return [2 /*return*/, response_handler_1.default.sendErrorResponse({ res: res, error: "username already taken" })];
                }
                referralId = null;
                if (!referralUsername) return [3 /*break*/, 5];
            ...
            case 3:
                referralUser = _d.sent();
                if (!referralUser) {
                    return [2 /*return*/, response_handler_1.default.sendErrorResponse({ res: res, error: "username is invalid" })];
                }
                referralId = referralUser.id;
                walletUpdate = pris_client_1.default.userWallet.update({ where: { id: (_b = referralUser.wallet) === null || _b === void 0 ? void 0 : _b.id }, data: {
                        referralBalance: { increment: constants_1.ReferralAmount }
                    } });
                transaction = pris_client_1.default.transactions.create({
                    data: { txRef: (0, transaction_utils_1.generateTransactionRef)(),
                        amount: constants_1.ReferralAmount,
                        userId: referralUser.id,
                        productDescription: "REFERRAL",
                        featureId: ((_c = referralUser.wallet) === null || _c === void 0 ? void 0 : _c.id) || "",
                        name: "Refferal bonus",
                        type: "CREDIT" }
                });
                notification = pris_client_1.default.notifications.create({ data: {
                        userId: referralUser.id,
                        type: "WALLET",
                        content: "You referred ".concat(username, " to vibe!")
                    }
                });
            ...
            case 4:
                _d.sent();
                _d.label = 5;
            case 5: return [4 /*yield*/, (0, user_utils_1.bcryptHash)(password)];
            case 6:
            ...
            case 7:
                ...
                _d.label = 8;
            case 8:
                if (!referralUsername) return [3 /*break*/, 10];
            ...
            case 9:
                ...
                _d.label = 10;
            case 10:
                otpCode = (0, user_utils_1.generateOTP)();
                return [4 /*yield*/, (0, mail_services_1.mailSender)({ to: email, subject: "VibeEasy Sign up code", body: otpCode, name: "VibeEasy Verification" })];
            case 11:
                _d.sent();
            ...
            case 12:
                otpObject = _d.sent();
                return [2 /*return*/, response_handler_1.default.sendSuccessResponse({ res: res, message: "Verification has been sent to email", data: {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, user_utils_1.bcryptCompare)({ password: password, hashedPassword: loginUser.password })];
            case 2:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                accessToken = (0, token_utils_1.signAccessToken)({ userId: user.userId, email: user.userId });
            ...
            case 4:
                _a.sent();
                _a.label = 5;
            case 5: return [2 /*return*/, response_handler_1.default.sendSuccessResponse({ res: res, data: {
                        accessToken: accessToken,
                        refreshToken: refreshToken,
                        user: user
                    } })];
...
exports.forgotPassword = (0, wrapper_1.catchDefaultError)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                otpObject = _a.sent();
                return [4 /*yield*/, (0, mail_services_1.mailSender)({ to: email, subject: "VibeEasy Reset password code", body: otpCode, name: "VibeEasy Verification" })];
            case 3:
                _a.sent();
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, user_utils_1.bcryptHash)(password)];
            case 2:
