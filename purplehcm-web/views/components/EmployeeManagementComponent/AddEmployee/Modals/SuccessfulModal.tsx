          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-[16px] font-[500] leading-[24px] text-[#475467] text-center ">
              {subTitle
                ? subTitle
                : details?.scheduleTimeName === "Schedule"
                ? "Account has been created and your scheduled invitation has been set up for the employee to get the invitation "
                : "Account has been created and invitation has been sent to the employee "}
            </p>
          </div>
        </div>
